...
- Сохранение встроенной правки изображения записывает получившееся изображение в выбранное место. Это отличается от ориентации отображения, которая хранится только в Lap.
...
- Коллекции и их состав
- Теги
- Комментарии
- Избранное, оценки и статусы проверки (включая Picks и Rejects)
- Ориентация отображения в Lap и другие состояния, относящиеся только к библиотеке
- Умные альбомы, а также их правила, группировка, сортировка и порядок
...
Lap может повторно сканировать папки и обнаруживать многие изменения файловой системы. Однако если файлы переименовываются, перемещаются, заменяются или копируются вне Lap, Lap не может гарантировать, что локальные связи — особенно принадлежность к коллекциям и другие данные только библиотеки — последуют за файлом.

Если ваш рабочий процесс зависит от коллекций, тегов, комментариев, избранного, оценок, статусов проверки или ориентации Lap, по возможности перемещайте и переименовывайте файлы в Lap. Если вы часто работаете вне Lap, считайте эти функции локальной организацией Lap и храните резервную копию базы данных и конфигурации Lap вместе с фотографиями. Посмотреть или изменить расположение базы данных, а также создать её резервную копию можно в **Настройки → Хранилище**.
