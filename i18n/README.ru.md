...
Если ваш рабочий процесс зависит от коллекций, тегов, комментариев, избранного, оценок, статуса отбора или ориентации Lap, по возможности перемещайте и переименовывайте файлы в Lap. Если вы часто работаете вне Lap, считайте эти функции локальной организацией Lap и храните резервную копию базы данных и конфигурации Lap вместе с фотографиями. Посмотреть или изменить расположение базы данных, а также создать её резервную копию можно в **Настройки → Хранилище**.
